...
public class Concord {
    ...
    public void printSorted(PrintStream out) {
        //ArrayList<Map.Entry<String, Integer>> tempArray = new ArrayList<>(concord.entrySet());
        List<Map.Entry<String, Integer>> tempArray = new ArrayList<>(concord.entrySet());
        Collections.sort(tempArray, new ConcordComparator());
        for (Map.Entry<String, Integer> curr: tempArray) {
            out.println((curr.getKey() + " " + curr.getValue()));
        }
    }
